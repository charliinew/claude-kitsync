...
team_mode: false # -t: Spawn Agent Teams for parallel multi-agent execution
...
IF {team_mode} = true:
  → Load steps/step-00b-team.md
  → Configure team composition and spawn prompts
  → Return here with {team_config} set
```
